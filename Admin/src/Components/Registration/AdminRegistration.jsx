...
const AdminRegister = () => {
  ...
  const validate = () => {
    ...
    if (!form.department.trim()) {
      next.department = "Enter your department";
    }

    if (!form.adminId.trim()) {
      next.adminId = "Enter an admin ID";
    }
            ...
            {submitted ? (
              ...
              >
                ...
                <form className="mt-8 space-y-5" onSubmit={handleSubmit} noValidate>
                  ...
                  <motion.div variants={itemVariants}>
                    <label htmlFor="mobile" className="block font-semibold text-gray-700 mb-2">
                      Mobile Number
                    </label>
                    <motion.input
                      whileFocus={{ scale: 1.01 }}
                  ...
                  <motion.div variants={itemVariants}>
                    <label htmlFor="department" className="block font-semibold text-gray-700 mb-2">
                      Department
                    </label>
                    <motion.input
                      whileFocus={{ scale: 1.01 }}
                  ...
                  <motion.div variants={itemVariants}>
                    <label htmlFor="adminId" className="block font-semibold text-gray-700 mb-2">
                      Admin ID
                    </label>
                    <motion.input
                      whileFocus={{ scale: 1.01 }}
